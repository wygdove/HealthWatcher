...
public class GetEarthquakesByCitycode {
	public static String getEarthquakesBycitycodeRspJson(String baseUrl,String accessId,String citycode) {
		String response=null;
		String url=baseUrl+"/getEarthquakesByCitycode";
