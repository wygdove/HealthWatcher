...
public class GetWeatherForecast {
	public static String getWeatherForecastGetRsp(String baseUrl,String accessId,String citycode) {
		String response = null;
		String url=baseUrl+"/getWeatherForecast?citycode="+citycode+"&ak="+accessId;
	...
	public static String getWeatherForecastPostRsp(String baseUrl,String accessId,List<String> citycodes) {
		String response=null;
		String url=baseUrl+"/getWeatherForecast";
