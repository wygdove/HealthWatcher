...
public class Test {
	...
	static final String BASEURL = "http://service.envicloud.cn:8082/api";
	static final String ACCESSID = "D3LNZG92ZTE0NDUXNTM2NTG4MZG=";

	private static String getRealtimeAirInfoGetRsp(String citycode) {
	...
	private static String getRealtimeAirInfoPostRsp(List<String> citycodes) {
		String response=null;
	...
	public static void main(String[] args) {
		...
		System.out.println(getRealtimeAirInfoGetRsp(citycode));

		List<String> citycodes = new ArrayList<String>();
		citycodes.add("101190101");
		System.out.println(getRealtimeAirInfoPostRsp(citycodes));
	}
