		...
		<div class="row">
			<div class="col-sm-12">
                <div class="widget white-bg">
					...
					<div class="row">
						<div class="echarts" id="chart_bo"></div>
					</div>
				</div>
			</div>
		</div>
...
function setbochartdata(dataxaxis,dataseries) {
	console.log(dataxaxis);
	console.log(dataseries);
	var bochart=echarts.init(document.getElementById("chart_bo"));
	booption={
