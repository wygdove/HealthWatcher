		...
		<div class="row">
			<div class="col-sm-12">
                <div class="widget white-bg">
					...
					<div class="row">
						<div class="echarts" id="chart_pulse"></div>
					</div>
				</div>
			</div>
		</div>
...
function setpulsechartdata(dataxaxis,dataseries) {
	console.log(dataxaxis);
	console.log(dataseries);
	var pulsechart=echarts.init(document.getElementById("chart_pulse"));
	pulseoption={
